    ...
    <Header/>
      ...
      <section className="hero">
        ...
        <section className='Fleet'>
          <h1>OUR FLEET <span className='check'>Check out some of our quality cars for you to enjoy</span></h1> 
  ...
  <div className='slider'>
    {cars.map((car) => (
      <div
        ...
        key={car._id}
        style={{
          backgroundImage: `url(http://localhost:3000/api/car_img/${car.image})`,
        }}
      >
        {/* Other content inside slider-cards if needed */}
      </div>
    ))}
  </div>
</div>

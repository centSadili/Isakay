...
const updateRent = require('./routes/rent/updateRent.js')
const getRent = require('./routes/rent/getRent.js')
const app = express()
//Database Connection
connectDB()
...
app.use('/api/resetpassword', forgotUser)
...
app.use('/api/rent/',updateRent)
app.use('/api/rents/',getRent)
